  ...
  def render(assigns) do
    ...
    <div class="flex items-center justify-center">
      <div class="max-w-md w-full bg-white p-10 rounded-2xl shadow-2xl border border-gray-100">
        ...
        <a
          href="/auth/google"
          class="w-ful    l flex items-center justify-center gap-3 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg border border-blue-700 transition text-lg shadow-md mb-4 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2"
        >
